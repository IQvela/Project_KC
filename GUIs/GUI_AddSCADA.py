...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.Title.setGeometry(QtCore.QRect(50, 50, 421, 41))
        font = QtGui.QFont()
        ...
        self.text_filepath.setGeometry(QtCore.QRect(110, 120, 271, 40))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def write_default_attrib(self):
        ...
        self.text_filepath.setPlaceholderText(_translate("MainWindow", "SCADA data file path"))
    ...
    def search_file(self):
        ...
        #print(default_path)
        file_name=QtWidgets.QFileDialog.getOpenFileName(self,"Open SCADA File",default_path,"Excel files (*.xls *.xlsx)")
